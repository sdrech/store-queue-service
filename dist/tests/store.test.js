...
const store_class_1 = __importDefault(require("../src/store/store.class"));
const VALID_KEY_A = 'a';
...
describe('=== Validation the constructor of Store Class ===', () => {
    test('positive number is a valid size of Store', () => {
        const store = new store_class_1.default(3);
    ...
    test('do not accept zero-sized Store', () => {
        expect(() => new store_class_1.default(0)).toThrow(Error);
        expect(() => new store_class_1.default(0)).toThrow(/Store size/);
    });
    test('do not accept negative numbers as a size of Store', () => {
        expect(() => new store_class_1.default(-1)).toThrow(Error);
        expect(() => new store_class_1.default(-1)).toThrow(/Store size/);
    });
...
describe('=== Validation acceptance criteria for Store Class ===', () => {
    let store;
    beforeEach(() => {
        store = new store_class_1.default(2);
    });
...
describe('=== Validation business logic for Store Class ===', () => {
    ...
    const maxSize = 2;
    beforeEach(() => {
        store = new store_class_1.default(maxSize);
    });
